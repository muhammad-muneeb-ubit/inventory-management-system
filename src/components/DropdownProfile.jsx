...
import UserAvatar from "../images/hydrafoods_logo.png";
...
const navigate = useNavigate(); 
  ...
  return (
    <>
    {user && ( <div className="relative inline-flex">
      <button
        ref={trigger}
      ...
      >
       <img
          className="w-8 h-8 bg-contain rounded-full"
          // src={UserAvatar}
          src={ user.role == "user"?`https://ui-avatars.com/api/?name=${user.name}&background=8b5cf6&color=fff`: UserAvatar}
